...
/** Default: local release APK produced by `npm run build:android`. */
const localApk = 'android/app/build/outputs/apk/release/app-release.apk';

const localAndroidCaps = {
  platformName: 'Android',
  'appium:automationName': 'UiAutomator2',
  'appium:deviceName': process.env.ANDROID_DEVICE_NAME || 'Android Emulator',
  'appium:app': resolveAppPath('MOBILE_APP_ANDROID_APP', localApk),
